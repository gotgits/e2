...
<body>
    ...
    <?php } ?>
    <br>
    <p>Concept visual diagramming the unique spot positions from a key-value multi-dimensional array that will contain
        conditional statements that effect the
        outcome of a player turn.</p>
    <img alt='5x5' src='5x5odd.png' style='width:500px;'>
