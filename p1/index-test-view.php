...
<head>
    <meta charset='UTF-8' />
    <title>TEST – Project 1 – 5x5 game simulation</title>
...
<body>
    ...
    <h1>TEST – Project 1 - 5x5 Game Simulation</h1>
    <h2>Mechanics</h2>
    <ol>
    ...
    <ul>
        ...
        <li class="winner">Round Winner – <?php echo $roundWinner ?>, Congratulations!</li>
    </ul>
    <h2>Results</h2>
